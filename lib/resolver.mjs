export const PROJECT_ALIASES = {
  'control': ['shino control', 'shino // control', 'project radar', 'resume hub', 'site de suivi projets', 'shinobione-shino-control', 'shino sync', 'shino-sync', 'extension shino sync'],
  ...
  'french-tranquille': ['tran-french-teacher', 'french tranquille', 'french teacher', "tran's french teacher", "trân's french teacher", 'tran french teacher'],
  ...
  'naughty-share': ['naughty share', 'naughtyshare'],
  'tran-closet-pwa': ['tran closet pwa', 'trân closet pwa', 'tran closet', 'trân closet'],
  'matos-informatique': ['matos informatique', 'matos info'],
  'analyse-ia-musique': ['analyse ia de musique', 'analyse ia musique', 'music ai analysis'],
  'track-to-market-engine': ['track-to-market engine', 'track to market engine', 'track-to-market'],
  'lrc-maker': ['lrc maker', 'lrc injection', 'musixmatch injection'],
  'web-app': ['web app'],
  'canva-spotify-gem': ['canva spotify gem', 'spotify canva gem']
};
