...
function classifyChat(e) {
  ...
  const hasNoRemainingWork = NO_REMAINING.test(stateText);
  const hasOpenWork = OPEN.test(stateText) && !hasNoRemainingWork;
  if ((hasNoRemainingWork || CLOSED.test(stateText)) && !hasOpenWork) {
